// user inputed values for the season and plant type
let season = prompt("Please enter the season");
let plantType = prompt("Please input what plant type you are working with");
// ensure that input is not case sensitive
